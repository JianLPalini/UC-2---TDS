...
console.log(filme.elenco[0],filme.nomePersonagem[0])
console.log(filme.elenco[1],filme.nomePersonagem[1])
console.log(filme.elenco[2],filme.nomePersonagem[2])
console.log(filme.elenco[3],filme.nomePersonagem[3])
filme.elenco[0]= "Xuxa"
console.log(filme)
